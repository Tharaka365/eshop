    ...
    <div class="offset-2 offset-lg-3 col-8 col-lg-6 text-center mb-3">
                    ...
                    <ul class="pagination pagination-lg justify-content-center">
                        ...
                        ?>
                                <li class="page-item active">
                                    <a class="page-link"><?php echo $x; ?></a>
                                </li>
                            <?php
                            } else {
                            ?>
            ...
            <div class="col-12 mt-3 mb-3">
                <div class="row">
                    ...
                    <div class="col-4 col-lg-2 bg-primary py-2">
                        <span class="fs-4 fw-bold text-white">Lahiru</span>
                    </div>
                    <div class="col-4 col-lg-2 d-lg-block bg-light py-2">
                        <span class="fs-4 fw-bold">lahiru@gmail.com</span>
                    </div>
                    <div class="col-2 d-none d-lg-block bg-primary py-2">
                        <span class="fs-4 fw-bold text-white">0756722784</span>
                    </div>
                    <div class="col-2 d-none d-lg-block bg-light py-2">
                        <span class="fs-4 fw-bold">2022-10-05</span>
                    </div>
